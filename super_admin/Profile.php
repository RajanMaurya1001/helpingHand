                        ...
                        <form action="" method="POST">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="firstName" name="first_name" placeholder="Enter first name" value="Sarah Johnson" required>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="postion" name="postion" value="Super Admin" required>
                                </div>
                                <!-- <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Position Image" class="img-thumbnail" width="120" style="border-radius: 50%;">
                                </div>
